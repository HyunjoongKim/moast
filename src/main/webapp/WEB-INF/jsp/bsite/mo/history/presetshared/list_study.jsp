		...
		$('#nextButton').click(function(){
			...
			<form:form commandName="searchVO" method="get" name="submitForm" id="submitForm" action="${path }/mo/visual/list_saved.do">
				...
				<div class="card-header ui-sortable-handle pl-1 pr-1 pt-0">
					<div class="row">
						<div class="col-lg-6">
							<h3 class="card-title h3icn">저장된 Preset</h3>
						</div>
						<div class="col-lg-6 text-right mt-2 location"><i class="fa fa-home"></i><i class="fa fa-chevron-right ml-2 mr-2"></i>분석히스토리<i class="fa fa-chevron-right ml-2 mr-2"></i>저장된 Preset </div>
					</div>
				</div>
				<!-- //title -->
								...
								<div class="card-body">
			                                ...
			                                <thead>
			                                    <tr>
			                                    	<th scope="col" rowspan="3">
			                                    		<c:if test="${searchVO.popYn ne 'Y'}">선택</c:if>
			                                    	</th>
													...
													<tr class="">
														...
														<td style="text-align:left"> 
															<div class="row">
																...
																<c:if test="${searchVO.popYn ne 'Y'}">
																	<div class="col-2"><a class="btn btn-sm btn-primary" href="${path}/mo/analysisdata/methylation/list.do?std_idx=${result.std_idx}">Primer 관리</a></div>
																</c:if>
																<c:if test='${result.std_type eq "A" }'>
													...
													<tr class="">
														...
														<td style="text-align:left">
															<div class="row">
																...
																<c:if test="${searchVO.popYn ne 'Y'}">
																	<div class="col-2"><a class="btn btn-sm btn-primary" href="${path}/mo/analysisdata/variant/list.do?std_idx=${result.std_idx}">Primer 관리</a></div>
																</c:if>
																<div class="col-1"></div>
									...
									<div class="row btn-area">
										<div class="col-12 text-right">
											<button type="button" class="btn btn-dark mr-2" onclick="history.back()" >뒤로가기</button>
											<c:if test="${searchVO.popYn ne 'Y'}">
												<button type="button" class="btn btn-success" id="nextButton">다음 <i class="fas fa-chevron-right"></i></button>
											</c:if>
										</div>
									</div>
								</div>
