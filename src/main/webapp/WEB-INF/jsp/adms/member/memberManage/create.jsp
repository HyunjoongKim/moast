...
<script type="text/javascript">
	...
	function _onSubmit(){
		...
		if($("#idCntRes").val() == ""){
			alert(gTxt("mb.validate.dup"));
			$("#idCnt").focus();
			return false;
		}
		
		if($("#idCntRes").val() == "false"){
			alert(gTxt("mb.validate.re"));
			$("#me_id").focus();
			return false;
		}
		
		if($("#me_pwd").val() == ""){
			alert(gTxt("mb.validate.pwd"));
			$("#me_pwd").focus();
			return false;
		}
	      	 ...
	      	 .done(function(resMap) {
	      		if(resMap.res == "ok"){
	      			if(resMap.idCnt == 0 && meId != "temp_999999"){
	      				$("#idCntRes").val("true");
	      				$("#idCntTxt").text(gTxt("txt.available"));
	      				$("#me_id").attr("readonly","readonly");
	      			}else{
	      				$("#idCntRes").val("false");
	      				$("#idCntTxt").text(gTxt("txt.unavailable"));
	      			}
	      		}
	      	 }) 
	      	 .fail(function(e) {  
	...
	function getThumbnailPrivew(html) {
	    ...
	    if (html.files && html.files[0]) {
	        ...
	        reader.onload = function (e) {
	            ...
	            $('#cma_image').html('<img src="' + e.target.result + '" style="width:180px; height:185px;" border="0" alt="" />');
	        }
...
<div id="contAreaBox">
	<form name="inputForm" method="post" onsubmit="return _onSubmit();" action="${path}/adms/member/memberManage/create_action.do"   enctype="multipart/form-data" class="form-horizontal">
		<div class="panel">
			<div class="panel-body">
				...
				<div class="table-responsive">
					<table id="datatable-scroller" class="table table-bordered tbl_Form">
						...
						<tbody>
							<tr>
								<th class="active" style="text-align:right"><span class="ftcdanger">*</span> <spring:message code="mb.id" text="아이디" /></th>
								<td class="form-inline">
									<input type="text" id="me_id" name="me_id"  class="form-control" style="width:300px" />
									<a href="javascript:void(0);" onclick="checkDupId();return false;" class="btn btn-dark" style="height:36px"><spring:message code="btn.checkDup" text="중복체크" /></a>
							...
							<tr>
								...
								<td>
									<input type="password" id="me_pwd" name="me_pwd"  class="form-control"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="password" id="me_pwd_chk" name="me_pwd_chk"  class="form-control"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="text" id="me_name" name="me_name" class="form-control"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<div class="radio radio-inline"> 
				                   		<input type="radio" name="me_is_cert" value="Y" checked /><label><spring:message code="mb.cert.y" text="인증" /> </label>
				                   	</div>
				                   	<div class="radio radio-inline">
				                   		<input type="radio" name="me_is_cert" value="N" /><label><spring:message code="mb.cert.n" text="미인증" /> </label>
				               		</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<div class="radio radio-inline "> 
				                   		<input type="radio" name="me_is_login" value="Y"  checked /><label><spring:message code="mb.login.y" text="가능" /></label>
				               		</div>
									<div class="radio radio-inline ">               		
				              		    <input type="radio" name="me_is_login" value="N" ><label><spring:message code="mb.login.n" text="불가능" /></label>
				               		</div>
								</td>
							</tr>
							...
							<tr>
				                ...
				                <td>
				                    <input type="text" id="tmp_me_bth" name="tmp_me_bth"  />
				                </td>
				            </tr>
				            <tr>
								<th class="active" style="text-align:right">Address<span class="nec"></span></th>
								<td>
									<input type="text" name="me_postno" id="me_postno" class="text w90" placeholder="zip code">
									<a href="javascript:void(0);" onclick="daumPostcode();return false;" class="btn btn-dark"><span>zip code</span></a>
									<br /><input type="text" id="me_address1" name="me_address1" style="width:500px" />
									<br /><input type="text" id="me_address2" name="me_address2" style="width:500px" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="me_agency" id="me_agency" style="width:500px" title="Institution" ></td>
							</tr>
							<tr>
								<th class="active" style="text-align:right"><label for="">Department</label></th>
								<td><input type="text" name="me_department" id="me_department" style="width:500px" title="Department" ></td>
							</tr>
							<tr>
								<th class="active" style="text-align:right"><label for="">Position</label></th>
								<td><input type="text" name="me_position" id="me_position" style="width:500px" title="Position" ></td>
							</tr>
		...
		<div class="pull-right">
			...
			<a href="${path}/adms/member/memberManage/list.do" class="btn btn btn-primary btn-lg"><spring:message code="btn.cancel" text="취소" /></a>
		</div>
	</form>
</div>
