...
<form:form commandName="searchVO" method="get" name="listForm" id="listForm" action="${path}/adms/common/menulog/list.do">
	<div class="panel">
		<div class="panel-body">
			<div class="form-inline" >
				<div class="form-group">
					<label class="control-label" for=""><spring:message code="log.site" text="사이트" /></label>
					<select name="search_siteCode" id="search_siteCode"  style="width:500px" class="form-control" >
					...
					<%-- <a href="${path}/adms/common/menulog/excelDown.do?search_siteCode=${searchVO.search_siteCode}" class="btn btn-warning" style="height:38px;"><spring:message code="btn.exceldown" text="엑셀다운로드" /></a> --%>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="panel">
		<div class="panel-body">
			<h4 class="mt0"><i class="fa fa-cube" aria-hidden="true"></i> <spring:message code="log.menu" text="메뉴로그기록" /></h4>	
			<div class="table-responsive">
				<table id="datatable-scroller" class="table table-striped table-bordered text-center">
					...
					<thead>
						<tr>
							<th>No</th>
							<th><spring:message code="log.menu.name" text="메뉴명" /></th>
					...
					<tbody>
						...
						<tr id="tr_${result.menu_idx}">
							<td><c:out value="${ii}"/></td>
							<td><c:out value="${result.menu_name}"/><a href="${path}${result.menu_target}" target="_blank">[<spring:message code="au.go" text="바로가기" />]</a></td>
