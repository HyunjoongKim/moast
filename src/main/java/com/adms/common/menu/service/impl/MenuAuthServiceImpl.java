...
public class MenuAuthServiceImpl extends EgovAbstractServiceImpl implements MenuAuthService{
	...
	@Override
	public void createAndUpdate(tbl_menu_manageVO searchVO) throws Exception {
	...
	private void createMenu(tbl_menu_manageVO searchVO) {
		dao.createMenu(searchVO);
	}
	...
	@Override
	public tbl_menu_subVO getAuthDetailData(LoginVO loginVO) throws Exception {
