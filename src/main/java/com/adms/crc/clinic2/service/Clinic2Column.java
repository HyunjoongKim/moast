...
public enum Clinic2Column {
	...
	Clinic2Column(String field, String title, boolean sortable, String width, boolean display) {
		this.field = field;
		this.title = title;
	...
	public static Stream<Clinic2Column> stream() {
        return Stream.of(Clinic2Column.values()); 
    }
