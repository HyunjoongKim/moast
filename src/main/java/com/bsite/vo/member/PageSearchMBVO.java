...
public abstract class PageSearchMBVO implements Serializable {
	...
	@Transient
	private	String	searchMeName	="";
	@Transient
	private	String	searchAuthCode	="";	
	@Transient
	private	String	searchMeType	="";
	//검색항목---------------------- 공통  ------------------------------
	...
	public void setQueryString() throws UnsupportedEncodingException {
		...
		//qs += "&searchMeId="+this.searchMeId;
		qs += "&searchMeName="+URLEncoder.encode(this.searchMeName, "UTF-8");
		//qs += "&searchAuthCode="+this.searchAuthCode;
		//qs += "&searchMeType="+this.searchMeType;
	...
	public String getSearchMeId() {
		return searchMeId;
	}
	public void setSearchMeId(String searchMeId) {
		this.searchMeId = searchMeId;
	}
	public String getSearchMeName() {
		return searchMeName;
	}
	public void setSearchMeName(String searchMeName) {
		this.searchMeName = searchMeName;
	}
	...
	public String getSearchMeType() {
		return searchMeType;
	}
	public void setSearchMeType(String searchMeType) {
		this.searchMeType = searchMeType;
	}
