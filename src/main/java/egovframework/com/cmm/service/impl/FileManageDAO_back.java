...
public class FileManageDAO_back extends EgovComAbstractDAO {
	...
	update("FileManageDAO.deleteInstFile", fvo);
	update("FileManageDAO.deleteInstDetailsFile", fvo);
    }
	...
	return (List<FileVO>)list("FileManageDAO.selectFileInfsByFileName", vo);
    }
	...
	public String getAtchNextFileId() {
		return (String)getSqlMapClientTemplate().queryForObject("FileManageDAO.getAtchNextFileId");
	}

	public int getSubFileTableRow(String atchFileId) {
		return (int)getSqlMapClientTemplate().queryForObject("FileManageDAO.getSubFileTableRow", atchFileId);
	}
	...
	public int isMainFileTableRow(String ATCH_FILE_ID, String SITE_CODE) {
		...
		return (int)getSqlMapClientTemplate().queryForObject("FileManageDAO.isMainFileTableRow", map);
	}
